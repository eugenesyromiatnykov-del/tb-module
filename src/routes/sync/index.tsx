    ...
    <div>
      ...
      <Card className="mt-4">
        ...
        <CardBody className="space-y-2 text-sm text-slate-600">
          <p>
            <b>1.</b> Відкрийте medics.ua в окремій вкладці Chrome (з установленим розширенням Medics Indicators).
          </p>
          <p>
            <b>2.</b> Виберіть тут амбулаторію й натисніть «Запустити». Розширення на стороні MIS опитує наш бекенд раз на 4 секунди, побачить активне завдання й почне обходити пацієнтів автоматично.
          </p>
          <p>
          ...
          <p>
            <b>4.</b> Поки виконується — <b>не клікайте по вкладці MIS</b>, інакше зіб'ється DOM-послідовність.
          </p>
        </CardBody>
      </Card>
    </div>
